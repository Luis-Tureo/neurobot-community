...
import {
  initializeThematicDaysDashboard,
  loadThematicDaysDashboard,
} from './thematic-days-dashboard.js';
...
initializeThematicDaysDashboard({ api, botScopedPath, showNotice });
...
window.addEventListener('bot-services-load', (event) => {
  ...
  if (visibleModules.has('thematic-days')) loaders.push(loadThematicDaysDashboard());
