...
| ------------------ | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| `COMMUNITY_GROUPS` | Grupos           | Inicio, perfil, conocimiento, historial, IA, mensajes automáticos, centro de pruebas, encuestas, moderación y estadísticas         | Catálogo, imágenes, menú comercial, horarios comerciales y solicitudes humanas                          |
